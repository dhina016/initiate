...
<script src="<?php echo base_url('assets/admin/'); ?>assets/libs/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
<script src="<?php echo base_url('assets/admin/'); ?>assets/libs/magnific-popup/meg.init.js"></script>
<!--This page plugins -->
...
<script src="<?php echo base_url('assets/admin/'); ?>dist/js/pages/dashboards/dashboard3.js"></script>
